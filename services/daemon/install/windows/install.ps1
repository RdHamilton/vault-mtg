...
$ConfigFile  = Join-Path $InstallDir 'daemon.yaml'
...
# Write a minimal YAML config file.  The daemon's config loader reads these
# keys; see services/daemon/internal/config/config.go.
@"
# MTGA Companion Daemon — local config
# Generated by install.ps1 on $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')
# Edit this file to change the BFF URL or rotate the auth token.
bff_url: "$BffUrl"
