...
```bash
cat "/Users/ramonehamilton/Documents/Personal Projects/MTGA-Companion/.claude/agents/changelogs/finance-controller.md"
```

After completing a task, append to `.claude/agents/changelogs/finance-controller.md`:
```markdown
