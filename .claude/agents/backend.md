...
If you touched multiple modules (e.g. services/bff AND services/sync), run all three commands in each module directory. If any command fails, fix the issue first. Do not open the PR until all three pass in all touched modules.
