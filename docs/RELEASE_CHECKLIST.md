...
- [ ] `docs/DAEMON_INSTALLATION.md` reflects any changed install steps, port changes, or new env vars for this release
- [ ] Verified `DAEMON_INSTALLATION.md` platform verification status is accurate (macOS tested, Windows/Linux status noted)
...
- Manual regression flows: `docs/REGRESSION.md`
- Daemon installation: `docs/DAEMON_INSTALLATION.md`
