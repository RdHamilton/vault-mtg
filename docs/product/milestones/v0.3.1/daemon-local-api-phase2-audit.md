...
**Status:** reference doc — Phase 2 SPA migration shipped 2026-05-11/12 across PRs #1872–#1887.
**Parent plan:** [daemon-local-api-plan.md](./daemon-local-api-plan.md)
**Live tracker:** `.claude/plans/spa-route-migration.md` (per-PR execution log + remaining work).
...
> **Note:** PR numbers in this doc (PR #1, PR #2, …) are the original pre-execution numbering. The actual shipped PRs are #1872 through #1887 — see the live tracker for the mapping. This doc is preserved as the architecture-of-record for the migration.
